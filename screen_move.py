...
class MainWindow(QMainWindow):
    def __init__(self, x, y, grid, title, counter, cybercity, main_instance):
        ...
        # self.timer = QTimer()
        # self.timer.timeout.connect(self.update_every_second)
    ...
    def switch_central_widget(self, num):
        ...
        if num%2 == 0 and self.title == "attacker":
            ...
            self.main_instance.render_image(self.title)
        # if num%2==0 and self.title == "defender":
        #     attack, defend = self.main_instance.toggle_screen(self.title)
        #     print(type(attack))
        #     self.attack_window = attack
        #     print("def here")
        #     self.setCentralWidget(self.attack_window)
        #     self.defend_window = defend
        #     # self.setCentralWidget(self.defend_window)
        #     print("def here")
        # elif num%2!=0 and self.title == "attacker":
        #     attack, defend = self.main_instance.toggle_screen(self.title)
...
class Main():
    ...
    def render_image(self, title):
        if title == "attacker":
            # self.attacker.attack_window = AttackerWindow(self)
    ...
    #         # self.attacker.attack_window = AttackerWindow(self)
    #         self.attacker.attack_window.create_widgets()
    #         print(type(self.attacker.attack_window))
    #         self.attacker.setCentralWidget(self.attacker.attack_window)
    #         # self.defender.defend_window = DefenderWindow(self)
    #         print(type(self.defender))
    #         print(type(self.defender.defend_window))
    #         self.defender.defend_window.update_image()
    #         # self.defender.setCentralWidget(self.defender.defend_window)
    #         return self.attacker.attack_window,self.defender.defend_window
    #     else:
    #         print("attack")
    #         self.attacker.attack_window.update_image()
    #         self.attacker.setCentralWidget(self.attacker.attack_window)
